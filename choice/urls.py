...
exam_extra_patterns = [
    ...
    path("<int:pk>/drillupdate", DrillUpdateView.as_view(), name="drill-update"),
    path("<int:pk>/drill", DrillListView.as_view(), name="drill-list"),
    path("create/", ExamCreateView.as_view(), name="exam-create"),
]

drill_extra_patterns = [
    path("<int:pk>/", MarkUpdateView.as_view(), name="mark-update",),
]

exam_answer_extra_patterns = [
    path("", ExamAnswerCreateView.as_view(), name="exam-answer-create"),
    path("<int:pk>/", ExamAnswerUpdateView.as_view(), name="exam-answer-update"),
]
urlpatterns = [
